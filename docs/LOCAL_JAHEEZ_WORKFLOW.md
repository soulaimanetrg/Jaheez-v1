...
| **Admin API** | Express 5, Node.js, PostgreSQL, Supabase service_role | ✅ ~97 endpoints covering all of the above; OTP (Infobip), Stripe payment sessions |
...
├── user-app/                  ← USER mobile app (Expo 55)
...
│   └── package.json
│
├── driver-app/                ← DRIVER mobile app (Expo 55)
│   ├── app/
