...
// Production store URLs - must be configured via EXPO_PUBLIC_STORE_URL_IOS/ANDROID
// These fallbacks are search URLs and should be replaced with direct app URLs before production
const STORE_URL_IOS = process.env.EXPO_PUBLIC_STORE_URL_IOS;
const STORE_URL_ANDROID = process.env.EXPO_PUBLIC_STORE_URL_ANDROID;
