import {
  ...
  CircleHelp, CirclePlus, CircleX, Clock3, CloudDownload, CloudOff, Copy,
  CreditCard, Eye, EyeOff, Flag, Flame, Gift, Globe, Grid2X2, Headphones,
  Heart, Home, Hourglass, Image, Info, KeyRound, Languages, List, LockKeyhole,
  LockOpen, LogOut, LucideIcon, LucideProps, Mail, MapPin, Megaphone, MessageCircle,
  MessagesSquare, Minus, Moon, Navigation, Package, PauseCircle, Pencil, Phone,
...
export const APP_ICON_STROKE_WIDTH = 1.9;
export const APP_ICON_ACTIVE_STROKE_WIDTH = 2.2;
...
const icons: Record<string, LucideIcon> = {
  ...
  close: X, 'close-circle': CircleX, 'close-circle-outline': CircleX,
  ...
  apps: Grid2X2, restaurant: Utensils, 'restaurant-outline': Utensils,
